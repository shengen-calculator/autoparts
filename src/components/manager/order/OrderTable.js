...
function createData(id, vendor, brand, number, description, note, ordered, approved, orderNumber, euro, uah, orderDate, shipmentDate, status) {
    return {id, vendor, brand, number, description, note, ordered, approved, orderNumber, euro, uah, orderDate, shipmentDate, status };
}
...
export default function OrderTable() {
    return(
        <EnhancedTable
            ...
            tableRow={tableRow}
            title="Замовлення"
            titleIcon={TitleIconEnum.railway}
            isFilterShown={false}
