            ...
            (
                ...
                FROM (
                         ...
                         SELECT ISNULL([Каталоги поставщиков_1].ID_Запчасти,
                                ...
                                CASE
                                    WHEN ISNULL(Поставщики_1.[IsEnsureDeliveryTerm],
                                                Поставщики.[IsEnsureDeliveryTerm]) = 1
                                        THEN 'Гарантированный срок поставки'
                                    ELSE Null END                                                                     AS IsEnsureDeliveryTermTitle,
                                CASE
                                    WHEN ISNULL(Поставщики_1.[IsQualityGuaranteed], Поставщики.[IsQualityGuaranteed]) =
                                         1 THEN 'Гарантия качества и соответсвия производителю'
                                    ELSE Null END                                                                     AS IsQualityGuaranteedTitle
                         FROM [Каталоги поставщиков] AS [Каталоги поставщиков_1]
                                  INNER JOIN
                              Поставщики AS Поставщики_1
                              ON [Каталоги поставщиков_1].ID_Поставщика = Поставщики_1.ID_Поставщика
                         ...
                         SELECT isnull([Каталоги поставщиков_1].Id_Запчасти,
                                ...
                                isnull([Каталоги поставщиков_1].[Время заказа],
                                       [Каталоги_поставщиков].[Время заказа])                                     as [Время заказа],
                                isnull([Каталоги поставщиков_1].[Время прихода],
                                       [Каталоги_поставщиков].[Время прихода])                                    as [Время прихода],
                                isnull([Каталоги поставщиков_1].[Номер запчасти],
