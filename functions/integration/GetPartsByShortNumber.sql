...
SELECT      [Каталоги поставщиков_1].ID_Запчасти as Id_Запчасти,
            ...
            [Каталоги поставщиков_1].OrderTimeText as [Время заказа],
            [Каталоги поставщиков_1].ArrivalTime as [Время прихода],
            [Каталоги поставщиков_1].WarehouseName,
            [Каталоги поставщиков_1].SupplierName,
...
SELECT     dbo.Поисковая.ID_Запчасти, dbo.Поисковая.ID_аналога AS ID_аналога, dbo.Поисковая.Брэнд, dbo.Поисковая.[Сокращенное название],
            NULL AS [Время заказа], NULL AS [Время прихода], NULL AS SupplierName, NULL AS WarehouseName,
